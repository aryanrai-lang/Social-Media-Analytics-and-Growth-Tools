...
const typeConfig: Record<string, { icon: React.ElementType; className: string }> = {
  reel: { icon: Video, className: "bg-purple-100 text-purple-700 border-purple-200" },
  carousel: { icon: Layers, className: "bg-blue-100 text-blue-700 border-blue-200" },
  image: { icon: Image, className: "bg-emerald-100 text-emerald-700 border-emerald-200" },
  story: { icon: Circle, className: "bg-orange-100 text-orange-700 border-orange-200" },
};
